//
//  PopUpPriceViewController4.swift
//  JB Beauty Studio
//
...
class PopUpPriceViewController4: BottomPopupViewController {
    
    private let labelTitle: UILabel = {
        let text = UILabel()
        text.text = "Мезотерапия"
    ...
    private let label: UILabel = {
        let text = UILabel()
        text.text = "Мезотерапия - Насыщение комплексом витаминов, минералов, аминокислот и другими полезными веществами."
        text.numberOfLines = 0
    ...
    @objc func addToCart() {
        ...
        vc.createItem(name: ProcedureName.procedureName4, price: Int64(ProcedurePrice.procedurePrice4), quantity: 1)
        dismiss(animated: true)
    }
