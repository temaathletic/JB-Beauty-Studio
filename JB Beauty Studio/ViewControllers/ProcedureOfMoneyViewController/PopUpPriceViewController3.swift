//
//  PopUpPriceViewController3.swift
//  JB Beauty Studio
//
...
class PopUpPriceViewController3: BottomPopupViewController {
    
    private let labelTitle: UILabel = {
        let text = UILabel()
        text.text = "Мезотерапия волос"
    ...
    private let label: UILabel = {
        let text = UILabel()
        text.text = "Мезотерапия волос - Насыщение микроэлементами, аминокислотами и витаминами с целью восстановления объема и качества волос."
        text.numberOfLines = 0
    ...
    @objc func addToCart() {
        ...
        vc.createItem(name: ProcedureName.procedureName3, price: Int64(ProcedurePrice.procedurePrice3), quantity: 1)
        dismiss(animated: true)
    }
