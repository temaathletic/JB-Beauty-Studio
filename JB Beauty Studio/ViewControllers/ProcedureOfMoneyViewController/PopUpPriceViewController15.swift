//
//  PopUpPriceViewController15.swift
//  JB Beauty Studio
//
...
class PopUpPriceViewController15: BottomPopupViewController {
    
    private let labelTitle: UILabel = {
        let text = UILabel()
        text.text = "Щечки-яблочки"
    ...
    private let label: UILabel = {
        let text = UILabel()
        text.text = "Щечки-яблочки - Восстановление объемов средней трети лица."
        text.numberOfLines = 0
    ...
    @objc func addToCart() {
        ...
        vc.createItem(name: ProcedureName.procedureName15, price: Int64(ProcedurePrice.procedurePrice15), quantity: 1)
        dismiss(animated: true)
    }
