//
//  PopUpPriceViewController16.swift
//  JB Beauty Studio
//
...
class PopUpPriceViewController16: BottomPopupViewController {
    ...
    @objc func addToCart() {
        ...
        vc.createItem(name: ProcedureName.procedureName16, price: Int64(ProcedurePrice.procedurePrice16), quantity: 1)
        dismiss(animated: true)
    }
