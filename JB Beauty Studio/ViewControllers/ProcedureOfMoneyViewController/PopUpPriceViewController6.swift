//
//  PopUpPriceViewController6.swift
//  JB Beauty Studio
//
...
class PopUpPriceViewController6: BottomPopupViewController {
    ...
    @objc func addToCart() {
        ...
        vc.createItem(name: ProcedureName.procedureName6, price: Int64(ProcedurePrice.procedurePrice6), quantity: 1)
        dismiss(animated: true)
    }
