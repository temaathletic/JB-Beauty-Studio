//
//  PopUpPriceViewController9.swift
//  JB Beauty Studio
//
...
class PopUpPriceViewController9: BottomPopupViewController {
    
    private let labelTitle: UILabel = {
        let text = UILabel()
        text.text = "Лицо под ключ 2"
    ...
    @objc func addToCart() {
        ...
        vc.createItem(name: ProcedureName.procedureName9, price: Int64(ProcedurePrice.procedurePrice9), quantity: 1)
        dismiss(animated: true)
    }
