//
//  PopUpPriceViewController11.swift
//  JB Beauty Studio
//
...
class PopUpPriceViewController11: BottomPopupViewController {
    
    private let labelTitle: UILabel = {
        let text = UILabel()
        text.text = "Коррекция носогубных складок"
    ...
    @objc func addToCart() {
        ...
        vc.createItem(name: ProcedureName.procedureName11, price: Int64(ProcedurePrice.procedurePrice11), quantity: 1)
        dismiss(animated: true)
    }
