//
//  PopUpPriceViewController8.swift
//  JB Beauty Studio
//
...
class PopUpPriceViewController8: BottomPopupViewController {
    
    private let labelTitle: UILabel = {
        let text = UILabel()
        text.text = "Лицо под ключ 1"
    ...
    @objc func addToCart() {
        ...
        vc.createItem(name: ProcedureName.procedureName8, price: Int64(ProcedurePrice.procedurePrice8), quantity: 1)
        dismiss(animated: true)
    }
