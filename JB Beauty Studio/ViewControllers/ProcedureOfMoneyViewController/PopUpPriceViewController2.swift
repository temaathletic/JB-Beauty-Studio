//
//  PopUpPriceViewController2.swift
//  JB Beauty Studio
//
...
class PopUpPriceViewController2: BottomPopupViewController {
    ...
    @objc func addToCart() {
        ...
        vc.createItem(name: ProcedureName.procedureName2, price: Int64(ProcedurePrice.procedurePrice2), quantity: 1)
        dismiss(animated: true)
    }
