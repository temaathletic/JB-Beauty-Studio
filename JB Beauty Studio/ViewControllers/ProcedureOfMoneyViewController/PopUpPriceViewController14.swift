//
//  PopUpPriceViewController14.swift
//  JB Beauty Studio
//
...
class PopUpPriceViewController14: UIViewController {
    
    private let labelTitle: UILabel = {
        let text = UILabel()
        text.text = "Носослезка"
    ...
    private let label: UILabel = {
        let text = UILabel()
        text.text = "Носослезки- исправление дефектов кожи под глазами: уменьшение носослезной борозды и неровностей, темных кругов под глазами."
        text.numberOfLines = 0
    ...
    @objc func addToCart() {
        ...
        vc.createItem(name: ProcedureName.procedureName14, price: Int64(ProcedurePrice.procedurePrice14), quantity: 1)
        dismiss(animated: true)
    }
