...
class PopUpPriceViewController7: BottomPopupViewController {
    
    private let labelTitle: UILabel = {
        let text = UILabel()
        text.text = "Липолитики"
    ...
    @objc func addToCart() {
        ...
        vc.createItem(name: ProcedureName.procedureName7, price: Int64(ProcedurePrice.procedurePrice7), quantity: 1)
        dismiss(animated: true)
    }
