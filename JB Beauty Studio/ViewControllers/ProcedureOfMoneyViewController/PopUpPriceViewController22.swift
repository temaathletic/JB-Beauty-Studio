//
//  PopUpPriceViewController22.swift
//  JB Beauty Studio
//
...
class PopUpPriceViewController22: BottomPopupViewController {
    
    private let labelTitle: UILabel = {
        let text = UILabel()
        text.text = "Гипергидроз женский"
    ...
    @objc func addToCart() {
        ...
        vc.createItem(name: ProcedureName.procedureName22, price: Int64(ProcedurePrice.procedurePrice22), quantity: 1)
        dismiss(animated: true)
    }
