//
//  PopUpPriceViewController19.swift
//  JB Beauty Studio
//
...
class PopUpPriceViewController19: BottomPopupViewController {
    ...
    private let label: UILabel = {
        let text = UILabel()
        text.text = "Ботулинотерапия межбровка - Благодаря действию ботокса между бровей часть мышечных волокон перестает реагировать на импульсы: кожа не стягивается, морщины больше не образуются или становятся менее глубокими."
        text.numberOfLines = 0
    ...
    @objc func addToCart() {
        ...
        vc.createItem(name: ProcedureName.procedureName19, price: Int64(ProcedurePrice.procedurePrice19), quantity: 1)
        dismiss(animated: true)
    }
