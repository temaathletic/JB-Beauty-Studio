//
//  PopUpPriceViewController21.swift
//  JB Beauty Studio
//
...
class PopUpPriceViewController21: BottomPopupViewController {
    ...
    @objc func addToCart() {
        ...
        vc.createItem(name: ProcedureName.procedureName21, price: Int64(ProcedurePrice.procedurePrice21), quantity: 1)
        dismiss(animated: true)
    }
