//
//  PopUpPriceViewController23.swift
//  JB Beauty Studio
//
...
class PopUpPriceViewController23: BottomPopupViewController {
    ...
    @objc func addToCart() {
        ...
        vc.createItem(name: ProcedureName.procedureName23, price: Int64(ProcedurePrice.procedurePrice23), quantity: 1)
        dismiss(animated: true)
    }
