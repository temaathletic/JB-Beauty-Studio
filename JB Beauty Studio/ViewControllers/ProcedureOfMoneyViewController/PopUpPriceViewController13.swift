//
//  PopUpPriceViewController13.swift
//  JB Beauty Studio
//
...
class PopUpPriceViewController13: BottomPopupViewController {
    
    private let labelTitle: UILabel = {
        let text = UILabel()
        text.text = "Коррекция формы носа"
    ...
    @objc func addToCart() {
        ...
        vc.createItem(name: ProcedureName.procedureName13, price: Int64(ProcedurePrice.procedurePrice13), quantity: 1)
        dismiss(animated: true)
    }
