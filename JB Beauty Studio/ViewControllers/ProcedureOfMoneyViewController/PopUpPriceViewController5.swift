//
//  PopUpPriceViewController5.swift
//  JB Beauty Studio
//
...
class PopUpPriceViewController5: BottomPopupViewController {
    
    private let labelTitle: UILabel = {
        let text = UILabel()
        text.text = "Плазмолифтинг"
    ...
    private let label: UILabel = {
        let text = UILabel()
        text.text = "Безоперационный плазмолифтинг - Уменьшение морщин, стрий (растяжек) и шрамов, удаление пигментных пятен, неудачного татуажа, следов постакне, родинок и бородавок."
        text.numberOfLines = 0
    ...
    @objc func addToCart() {
        ...
        vc.createItem(name: ProcedureName.procedureName5, price: Int64(ProcedurePrice.procedurePrice5), quantity: 1)
        dismiss(animated: true)
    }
