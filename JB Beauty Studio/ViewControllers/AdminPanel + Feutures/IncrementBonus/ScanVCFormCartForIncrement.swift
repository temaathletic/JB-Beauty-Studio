//
//  ScanVCFormCartForIncrement.swift
//  JB Beauty Studio
//
...
class ScanVCFormCartForIncrement: UIViewController, AVCaptureMetadataOutputObjectsDelegate {
    ...
    func found(_ code: String) {
       ...
       AudioServicesPlaySystemSound(systemSoundID)
        ...
        Service.afterBlock(seconds: 0, queue: .main, complition: { [ weak self ] in
            let scene = UserIncrementBonus()
            scene.uidFromScaner = self!.stringValue2
