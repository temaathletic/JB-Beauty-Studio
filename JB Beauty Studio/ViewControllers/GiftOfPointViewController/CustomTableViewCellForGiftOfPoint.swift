...
//  JB Beauty Studio
//
//  Created by temaathletic on 08.01.2023.
//

import UIKit
import SnapKit

class CustomTableViewCellForGiftOfPoint: UITableViewCell {
    ...
    lazy var price: UILabel = {
        ...
        view.font = UIFont(name: "GlacialIndifference-Bold", size: 25)
        return view
    }()
...
//        backgroundColor = UIColor(patternImage: UIImage(named: "MainBG")!)
